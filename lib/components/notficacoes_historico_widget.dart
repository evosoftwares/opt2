...
import 'notficacoes_historico_model.dart';
export 'notficacoes_historico_model.dart';

class NotficacoesHistoricoWidget extends StatefulWidget {
  const NotficacoesHistoricoWidget({super.key});

  @override
  State<NotficacoesHistoricoWidget> createState() =>
      _NotficacoesHistoricoWidgetState();
}

class _NotficacoesHistoricoWidgetState
    extends State<NotficacoesHistoricoWidget> {
  late NotficacoesHistoricoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotficacoesHistoricoModel());
  }
                ...
                StreamBuilder<List<NotificacoesRecord>>(
                  stream: queryNotificacoesRecord(
                    queryBuilder: (notificacoesRecord) =>
                        notificacoesRecord.orderBy('horario'),
                  ),
                                      ...
                                      StreamBuilder<List<UsersRecord>>(
                                        stream: queryUsersRecord(
                                          queryBuilder: (usersRecord) =>
                                              usersRecord.where(
                                            'uid',
                                            isEqualTo: columnNotificacoesRecord
                                                .motorista?.id,
                                          ),
                                          singleRecord: true,
                                        ),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            dateTimeFormat(
                                              "d/M/y  h:mm",
                                              columnNotificacoesRecord.horario!,
                                              locale:
