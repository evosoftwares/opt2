...
class CorridasWidget extends StatefulWidget {
  ...
  static String routeName = 'Corridas';
  static String routePath = 'corridas';
        ...
        child: Padding(
          ...
          child: FutureBuilder<List<ViagensRow>>(
            ...
            builder: (context, snapshot) {
              ...
              List<ViagensRow> columnViagensRowList = snapshot.data!;

              if (columnViagensRowList.isEmpty) {
                return Center(
                  child: Image.asset(
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children:
                      List.generate(columnViagensRowList.length, (columnIndex) {
                    final columnViagensRow = columnViagensRowList[columnIndex];
                    return Padding(
                      padding:
                                          ...
                                          children: [
                                            ...
                                            AutoSizeText(
                                              valueOrDefault<String>(
                                                columnViagensRow.enderecoOrigem,
                                                'Origem ',
                                              ),
                                  ...
                                  child: StreamBuilder<List<UsersRecord>>(
                                    stream: queryUsersRecord(
                                      queryBuilder: (usersRecord) =>
                                        ...
                                        'uid',
                                        isEqualTo:
                                            columnViagensRow.motoristaReference,
                                      ),
                                      singleRecord: true,
                                    ),
                                    builder: (context, snapshot) {
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        formatNumber(
                                          columnViagensRow.precosugerido,
