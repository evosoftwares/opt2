...
import '/components/notficacoes_historico_motoristas_widget.dart';
...
class _PrincipalWidgetState extends State<PrincipalWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().supabaseUrl = 'https://qlbwacmavngtonauxnte.supabase.co';
      safeSetState(() {});
      _model.instantTimer = InstantTimer.periodic(
        duration: Duration(milliseconds: 5000),
        callback: (timer) async {
          _model.viagemIdPageState =
                                ...
                                builder: (context) =>
                                  ...
                                  stream: queryNotificacoesRecord(
                                    queryBuilder: (notificacoesRecord) =>
                                        notificacoesRecord.where(Filter.or(
                                      Filter(
                                        'motorista',
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<NotificacoesRecord>
                                        containerNotificacoesRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final containerNotificacoesRecord =
                                        containerNotificacoesRecordList
                                                .isNotEmpty
                                            ? containerNotificacoesRecordList
                                                .first
                                        ...
                                        children: [
                                          InkWell(
                                                  ...
                                                  return Padding(
                                                    padding:
                                                        MediaQuery.viewInsetsOf(
                                                            context),
                                                    child:
                                                        NotficacoesHistoricoMotoristasWidget(),
                                                  );
                                                },
                                              ).then((value) =>
                                                  safeSetState(() {}));
                                            ...
                                            child: Icon(
                                              ...
                                              color: () {
                                                if (containerNotificacoesRecord
                                                        ?.tipoMensagem ==
                                                    'Urgente') {
                                                  return FlutterFlowTheme.of(
                                                          context)
                                                      .accent4;
                                                } else if (containerNotificacoesRecord
                                                        ?.tipoMensagem ==
                                                    'Informativo') {
                                                  return FlutterFlowTheme.of(
                                                          context)
                ...
                builder: (context) => FutureBuilder<List<ViagensRow>>(
                  future: ViagensTable().querySingleRow(
                    queryFn: (q) => q
                        ...
                        .inFilterOrNull(
                          'status',
                          _model.listastatus.map((e) => e.name).toList(),
                        ),
                  ),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    ...
                    final columnViagensRow = columnViagensRowList.isNotEmpty
                        ? columnViagensRowList.first
                        : null;
                        ...
                        Stack(
                          children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Você não está recebendo corridas',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .headlineMedium
                                            ...
                                            if ((columnViagensRow?.status !=
                                                        null &&
                                                    columnViagensRow?.status !=
                                                        '') &&
                                                ((columnViagensRow?.status ==
                                                        Status.Aceito.name) ||
                                                    (columnViagensRow?.status ==
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Você possuí uma corrida em andamento',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .headlineMedium
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Receber corridas'),
                                                                  content: Text(
                                                                      'Você está pronto para receber corridas?'),
                                                                  actions: [
                                                                    TextButton(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Encerrar trabalho'),
                                                                  content: Text(
                                                                      'Você não receberá mais corridas, tem certeza?'),
                                                                  actions: [
                                                                    TextButton(
                                                                      onPressed: () => Navigator.pop(
                                                                          alertDialogContext,
                                                    ...
                                                    if (confirmDialogResponse) {
                                                      ...
                                                      await actions
                                                          .encerrarLocEmTempoReal();
                                                      FFAppState().navBarMenu =
                                                          false;
                                                      safeSetState(() {});
                                                    }
                                                  },
                                            ...
                                            if ((columnViagensRow?.status !=
                                              ...
                                              Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    context.pushNamed(
                                                      DetalhesCorridaMotoristaWidget
                                                          .routeName,
                                                      queryParameters: {
                                                        'qualCorrida':
                                                            serializeParam(
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 40.0, 0.0, 0.0),
                                              child: Text(
                                                'Estamos aguardando sua corrida ser aceita ou rejeitada',
                            ...
                            if ((valueOrDefault(
                                ...
                                (valueOrDefault<bool>(
                                        currentUserDocument?.aceitou, false) ==
                                    false))
                              Align(
                                alignment: AlignmentDirectional(0.0, 1.0),
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 50.0),
                                  child: wrapWithModel(
                                    model: _model.aceitarCorridaModel,
                                    updateCallback: () => safeSetState(() {}),
                                    child: AceitarCorridaWidget(
                                      idReceberPage: _model.viagemIdPageState!,
                                    ),
                                  ),
                                ),
                              ),
