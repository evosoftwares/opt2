    ...
    switch (T) {
      ...
      case SpatialRefSysRow:
        return SpatialRefSysRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case ModeloDeCarrosRow:
        return ModeloDeCarrosRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case GeometryColumnsRow:
        return GeometryColumnsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case MarcaDeCarrosRow:
        return MarcaDeCarrosRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case ViagensRow:
        return ViagensRow(json.decode(param) as Map<String, dynamic>) as T;
      case OfertasRow:
        return OfertasRow(json.decode(param) as Map<String, dynamic>) as T;
      case GeographyColumnsRow:
        return GeographyColumnsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case CategoriasRow:
        return CategoriasRow(json.decode(param) as Map<String, dynamic>) as T;
      case PagamentosRow:
        return PagamentosRow(json.decode(param) as Map<String, dynamic>) as T;
      case AnoVeiculosRow:
        return AnoVeiculosRow(json.decode(param) as Map<String, dynamic>) as T;
      case AvaliacoesRow:
        return AvaliacoesRow(json.decode(param) as Map<String, dynamic>) as T;
      case LocalizacaoMotoristaRow:
        return LocalizacaoMotoristaRow(
