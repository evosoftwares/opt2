...
class InicioClienteWidget extends StatefulWidget {
  const InicioClienteWidget({super.key});
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                if ((valueOrDefault(currentUserDocument?.idViagem, 0) ==
                        null) ||
                    (valueOrDefault(currentUserDocument?.idViagem, 0) <= 0))
                  Padding(
                    padding:
                          ...
                          child: Column(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  context
                                      .pushNamed(ChamarCarro1Widget.routeName);
                                },
                                text: 'Buscar corrida',
                      ...
                      builder: (context) => Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Você possui uma corrida em andamento',
                                style: FlutterFlowTheme.of(context)
                                    .titleSmall
                                    .override(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => FutureBuilder<List<ViagensRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<ViagensRow> containerViagensRowList =
                            snapshot.data!;
                        ...
                        return Container(
                          ...
                          child: Visibility(
                            visible: (containerViagensRow?.status ==
                                  ...
                                  if (_model.avalie)
                                    wrapWithModel(
                                      ...
                                      child: AvaliacaoWidget(
                                        qualCorrida: containerViagensRow!,
                                      ),
                                    ),
                                ].divide(SizedBox(height: 16.0)),
                              ),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed(CorridasWidget.routeName);
                                },
                                child: Text(
                                  'Ver todos',
                                  style: FlutterFlowTheme.of(context)
                          ...
                          FutureBuilder<List<ViagensRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ViagensRow> listViewViagensRowList =
                                  snapshot.data!;

                              if (listViewViagensRowList.isEmpty) {
                                return Center(
                                  child: Image.asset(
                              ...
                              return ListView.builder(
                                ...
                                itemCount: listViewViagensRowList.length,
                                itemBuilder: (context, listViewIndex) {
                                  final listViewViagensRow =
                                      listViewViagensRowList[listViewIndex];
                                  return Material(
                                    color: Colors.transparent,
                                    child: ListTile(
                                      leading: Icon(
                                      ...
                                      title: Text(
                                        listViewViagensRow.enderecoDestino!,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                                      ...
                                      subtitle: Text(
                                        listViewViagensRow.enderecoOrigem!,
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                              font: GoogleFonts.inter(
