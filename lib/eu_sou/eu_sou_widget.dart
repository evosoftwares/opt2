...
class _EuSouWidgetState extends State<EuSouWidget> {
  late EuSouModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EuSouModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Text(
                              'Escolha qual interesse você tem dentro da OPT',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    font: GoogleFonts.poppins(
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: Image.asset(
                                                  'assets/images/Screen-Shot-2020-02-28-at-2.webp',
                                                  width: 146.0,
                                                  height: 123.0,
                                                  fit: BoxFit.contain,
                                                ),
                                            ...
                                            Align(
                                              ...
                                              child: ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(30.0),
                                                child: Image.asset(
                                                  'assets/images/Tax-information-(1).webp',
                                                  width: 146.0,
                                                  height: 123.0,
                                                  fit: BoxFit.contain,
                                                ),
