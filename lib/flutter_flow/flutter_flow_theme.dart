...
abstract class FlutterFlowTheme {
  ...
  late Color gray;
  late Color primaryTwo;
  late Color primaryThree;
  late Color secondryTwo;
  late Color secondryThree;
  late Color shadowBox;
  late Color subText;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0xFF09091A);
  late Color accent2 = const Color(0xFFFFC043);
  late Color accent3 = const Color(0xFF1FBAD6);
  late Color accent4 = const Color(0xFFFF3C3C);
  ...
  late Color primaryBtnText = const Color(0xFFE4DFFF);
  late Color lineColor = const Color(0xFFD6D9E0);
  late Color gray = const Color(0xFFE4DFFF);
  late Color primaryTwo = const Color(0xFF8C80F8);
  late Color primaryThree = const Color(0xFFAF8EFF);
  late Color secondryTwo = const Color(0xFF8FACFF);
  late Color secondryThree = const Color(0xFF59B9FD);
  late Color shadowBox = const Color(0x40000000);
  late Color subText = const Color(0xFF9C9EB9);
}
